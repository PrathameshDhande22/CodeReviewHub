...
const Footer = () => {
  return (
    <footer className={`${space_grotesk.className} dark:bg-neutral flex flex-row flex-wrap justify-between gap-2 p-4 items-center`}>
      {/* Logo */}
      <div>
        ...
        <div className="uppercase font-semibold text-neutral-500 md:text-sm text-xs">
          @ {new Date().getUTCFullYear()} The Code Review Hub. The Digital
          Architect
        </div>
      </div>
      {/* Footer Nav Links */}
